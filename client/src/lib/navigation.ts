...
export const pages: PageInfo[] = [
  ...
  { step: 17, path: '/react/css-basics/plain-css', title: 'プレーン CSS と CSS Modules', sectionId: 'css-basics', manualId: 'react' },
  { step: 18, path: '/react/css-basics/css-in-js', title: 'CSS-in-JS の考え方', sectionId: 'css-basics', manualId: 'react' },
  { step: 19, path: '/react/css-basics/styled-components', title: 'styled-components', sectionId: 'css-basics', manualId: 'react' },
  { step: 20, path: '/react/css-basics/emotion', title: 'Emotion', sectionId: 'css-basics', manualId: 'react' },
  { step: 21, path: '/react/css-basics/css-patterns', title: 'CSS 設計パターン', sectionId: 'css-basics', manualId: 'react' },
  { step: 22, path: '/react/tailwind/intro', title: 'Tailwind CSS 入門', sectionId: 'tailwind', manualId: 'react' },
  { step: 23, path: '/react/tailwind/responsive-dark', title: 'レスポンシブとダークモード', sectionId: 'tailwind', manualId: 'react' },
  { step: 24, path: '/react/tailwind/shadcn', title: 'shadcn/ui', sectionId: 'tailwind', manualId: 'react' },
  { step: 25, path: '/react/mui/intro', title: 'MUI 7 入門', sectionId: 'mui', manualId: 'react' },
  { step: 26, path: '/react/mui/components', title: 'MUI コンポーネント活用', sectionId: 'mui', manualId: 'react' },
  { step: 27, path: '/react/mui/customization', title: 'MUI カスタマイズ', sectionId: 'mui', manualId: 'react' },
  { step: 28, path: '/react/practice-app/api', title: 'API 連携', sectionId: 'practice-app', manualId: 'react' },
  { step: 29, path: '/react/practice-app/routing', title: 'React Router', sectionId: 'practice-app', manualId: 'react' },
  { step: 30, path: '/react/practice-app/portfolio', title: 'ポートフォリオサイト制作', sectionId: 'practice-app', manualId: 'react' },
  { step: 31, path: '/react/nextjs-basics/what-is-nextjs', title: 'Next.js とは', sectionId: 'nextjs-basics', manualId: 'react' },
  { step: 32, path: '/react/nextjs-basics/project-setup', title: 'Next.js プロジェクト作成', sectionId: 'nextjs-basics', manualId: 'react' },
  { step: 33, path: '/react/nextjs-basics/routing', title: 'ページとルーティング', sectionId: 'nextjs-basics', manualId: 'react' },
  { step: 34, path: '/react/nextjs-basics/layout', title: 'レイアウトとナビゲーション', sectionId: 'nextjs-basics', manualId: 'react' },
  { step: 35, path: '/react/nextjs-server/rsc', title: 'Server Components', sectionId: 'nextjs-server', manualId: 'react' },
  { step: 36, path: '/react/nextjs-server/client', title: 'Client Components', sectionId: 'nextjs-server', manualId: 'react' },
  { step: 37, path: '/react/nextjs-server/data-fetching', title: 'データフェッチング', sectionId: 'nextjs-server', manualId: 'react' },
  { step: 38, path: '/react/nextjs-server/loading-error', title: 'Loading / Error UI', sectionId: 'nextjs-server', manualId: 'react' },
  { step: 39, path: '/react/nextjs-practice/route-handlers', title: 'Route Handlers', sectionId: 'nextjs-practice', manualId: 'react' },
  { step: 40, path: '/react/nextjs-practice/server-actions', title: 'Server Actions', sectionId: 'nextjs-practice', manualId: 'react' },
  { step: 41, path: '/react/nextjs-practice/middleware', title: 'ミドルウェアと認証', sectionId: 'nextjs-practice', manualId: 'react' },
  { step: 42, path: '/react/nextjs-practice/optimization', title: '画像最適化とメタデータ', sectionId: 'nextjs-practice', manualId: 'react' },
  { step: 43, path: '/react/nextjs-css/tailwind-mui', title: 'Next.js × Tailwind / MUI', sectionId: 'nextjs-css', manualId: 'react' },
  { step: 44, path: '/react/nextjs-css/css-modules-sc', title: 'Next.js × CSS Modules / styled-components', sectionId: 'nextjs-css', manualId: 'react' },
  { step: 45, path: '/react/deploy/vercel', title: 'Vercel デプロイ', sectionId: 'deploy', manualId: 'react' },
  { step: 46, path: '/react/deploy/summary', title: '総まとめと次のステップ', sectionId: 'deploy', manualId: 'react' },
  { step: 47, path: '/react/storybook/intro', title: 'Storybook とは', sectionId: 'storybook', manualId: 'react' },
  { step: 48, path: '/react/storybook/setup', title: 'Storybook 導入と初期画面', sectionId: 'storybook', manualId: 'react' },
  { step: 49, path: '/react/storybook/structure', title: 'Story の書き方と構造', sectionId: 'storybook', manualId: 'react' },
  { step: 50, path: '/react/storybook/css', title: 'CSS 環境別 Storybook 表示', sectionId: 'storybook', manualId: 'react' },
  { step: 51, path: '/react/storybook/figma', title: 'Figma 連携と Chromatic', sectionId: 'storybook', manualId: 'react' },
  { step: 52, path: '/react/storybook/advanced', title: 'Storybook 応用とカスタマイズ', sectionId: 'storybook', manualId: 'react' },
  { step: 53, path: '/react/architecture/overview', title: 'React / Next.js アーキテクチャ総論', sectionId: 'architecture', manualId: 'react' },
  { step: 54, path: '/react/architecture/design-system', title: 'デザインシステムの設計と構築', sectionId: 'architecture', manualId: 'react' },
  { step: 55, path: '/react/architecture/maintenance', title: '長期運用とチーム開発', sectionId: 'architecture', manualId: 'react' },
  ...
  { step: 29, path: '/claude-mux/reference/session-management', title: '環境の永続化', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 30, path: '/claude-mux/reference/troubleshooting', title: 'トラブルシューティング', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 31, path: '/claude-mux/reference/claude-cheatsheet', title: 'Claude Code チートシート', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 32, path: '/claude-mux/reference/tmux-cheatsheet', title: 'tmux チートシート', sectionId: 'reference', manualId: 'claude-mux' },
  { step: 33, path: '/claude-mux/best-practices/effective-workflows', title: '効果的なワークフロー', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 34, path: '/claude-mux/best-practices/spec-driven-dev', title: '仕様駆動開発 (SDD)', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 35, path: '/claude-mux/best-practices/testing-debugging', title: 'テストとデバッグの戦略', sectionId: 'best-practices', manualId: 'claude-mux' },
  { step: 36, path: '/claude-mux/hooks-advanced/hooks-guide', title: 'Hooks の設計と実装', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 37, path: '/claude-mux/hooks-advanced/hooks-recipes', title: 'Hooks 実践レシピ', sectionId: 'hooks-advanced', manualId: 'claude-mux' },
  { step: 38, path: '/claude-mux/ci-cd/github-actions', title: 'GitHub Actions 連携', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 39, path: '/claude-mux/ci-cd/headless-mode', title: 'ヘッドレスモードと自動化', sectionId: 'cicd-headless', manualId: 'claude-mux' },
  { step: 40, path: '/claude-mux/ide-agent-teams/ide-integration', title: 'VS Code・JetBrains 連携', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 41, path: '/claude-mux/ide-agent-teams/agent-orchestration', title: 'エージェントチームの協調', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 42, path: '/claude-mux/ide-agent-teams/plugins-ecosystem', title: 'プラグインとエコシステム', sectionId: 'ide-agent-teams', manualId: 'claude-mux' },
  { step: 43, path: '/claude-mux/multi-ai/multi-ai-coexistence', title: 'マルチAIツールの共存戦略', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
  { step: 44, path: '/claude-mux/multi-ai/single-source-of-truth', title: 'シングルソースオブトゥルース設計', sectionId: 'multi-ai-architecture', manualId: 'claude-mux' },
];
